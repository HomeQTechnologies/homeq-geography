...
id, old_id, and hash. Each package is keyed by tatortskod.
...
def flatten_urban_areas(source: Path, output_dir: Path) -> tuple[int, int, int]:
    ...
    for feature in features:
        ...
        metadata, is_new = resolve_metadata(existing_package, METADATA_TYPE, tatort)
...
def main() -> None:
    args = parse_args()
    written, new_count, skipped = flatten_urban_areas(args.geojson, args.output_dir)
    print(
